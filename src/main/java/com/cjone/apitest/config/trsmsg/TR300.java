...
public class TR300 {
        ...
        private String i_11 = "20240320";   // 결제일자
        private String i_12 = "20240320";   // 매출일자
        private String i_13 = "1001";   // 거래사유코드
        private String i_14 = "";   // 원통합승인일자
        private String i_15 = "";   // 원통합승인번호
        private String i_16 = "";   // 원고유식별번호
        private String i_17 = "devonepay";   // 사용자ID
        private String i_18 = "2024032011";   // 참여사고유식별번호
        private String i_19 = "";   // 결제(주문)번호
        private String i_20 = "";   // 비고
        private String i_21 = "1";   // 사용총건수
        private String i_22 = "11";   // 포인트사용유형
        private String i_23 = "100";   // 사용/사용취소포인트
